...
<h2 class="font-weight-bold text-center">Update Category</h2>
...
<form method="post">
    <div class="form-group row">
        ...
        <div class="col-md-4">
            <input class="form-control" type="text" name="name" value="${category.categoryName}"/>
        </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-4">
            <input class="form-control" type="text" name="desc" value="${category.categoryDesc}"/>
        </div>
        <div class="col-md-4"></div>
    </div>
    <div class="row">
