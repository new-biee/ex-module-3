            ...
            <form method="get" class="input-group">
                <div class="row col-md-12">
                    <div class="col-md-6">
                        <div class="col-md-12">
                            <div class="col-md-4">
                                <a href="/product?action=create" class="btn btn-primary">Add new Category</a>
                            </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <c:forEach var="product" items="${productList}">
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="/category?action=edit&id=${product.id}"
                                       style="color: white; ">
                                        Edit
                                    </a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
...
<script>
    function deleteClick(id) {
        console.log(id);
        document.getElementById('remove').action = '/product?action=remove&id=' + id;
